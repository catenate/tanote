...
=/  all0=front:tanote  [tab="default" tags=~ tugs=~ regards=~ histories=help0]
=/  all1=front:tanote  [tab="default" tags=~ tugs=~ regards=~ histories=help1]
=/  filter-regards0=front:tanote  (filter-front-regards:tanote [tab="histories" tags=~ tugs=~ regards="history" histories=help0])
=/  filter-field1=front:tanote  (filter-front-tugs:tanote [tab="field" tags=~ tugs=(sy ~["#field"]) regards=~ histories=help1])
...
:-  .=  (extract-backlinks-store:tanote help1)
    (sy ~["reviewer" "history" "note" "regards" "re" "note"])
...
:-  (display-tags:tanote help0)
:-  .=  (display-tags:tanote help0)
    (sy ~["*" "/" "#field"])
:-  (display-tags:tanote help1)
:-  .=  (display-tags:tanote help1)
    (sy ~["*" "/" "#field" "#list" "#tape"])
:-  (display-backlinks:tanote help0)
:-  .=  (display-backlinks:tanote help0)
    (sy ~["reviewer"])
:-  (display-backlinks:tanote help1)
:-  .=  (display-backlinks:tanote help1)
    (sy ~["reviewer" "history" "note" "regards" "re" "note"])
:-  (list-regards-store:tanote help0)
:-  .=  (list-regards-store:tanote help0)
    ~["store" "history" "note"]
:-  all0
:-  .=  histories.all0
    help0
:-  .=  (list-regards-store:tanote histories.all0)
    ~["store" "history" "note"]
:-  all1
:-  .=  histories.all1
    help1
:-  .=  (list-regards-store:tanote histories.all1)
    ~["note" "history" "store"]
:-  filter-regards0
:-  .=  filter-regards0
    [tab="histories" tags=~ tugs=~ regards="history" histories=~[history-history]]
:-  filter-field1
~
