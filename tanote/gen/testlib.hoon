...
|=  *
:-  %noun
=/  test0=note:tanote  [~ponhec-picwen "tester" ~ "test" "This is a test."]
=/  test1=note:tanote  [~ponhec-picwen "tester" ~[~ponhec-picwen] "test" "This is a test."]
=/  test2=note:tanote  [~ponhec-picwen "tester" ~[~ponhec-picwen ~nocsyx-lassul] "test" "This is a test."]
=/  tagbl0=note:tanote  [~ponhec-picwen "tester" ~[~ponhec-picwen ~nocsyx-lassul] "tag and backlink" "This is a test with a #tag and a [[backlink]]."]
=/  test10=note:tanote  [~ponhec-picwen "tester" ~ "another test" "This is a #test with a [[backlink]]."]
=/  test11=note:tanote  [~ponhec-picwen "tester" ~[~ponhec-picwen] "another test" "This is another #test with two #tag and two [[backlink]] for [[tanote]]."]
=/  test12=note:tanote  [~ponhec-picwen "tester" ~[~ponhec-picwen ~nocsyx-lassul] "another test" "This is another #test with an #array of #tag and more [[backlink]] for [[tanote]] [[test data]]."]
